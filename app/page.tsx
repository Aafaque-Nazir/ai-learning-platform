...
function NavButton({
  ...
  return (
    ...
    >
      <span
        className={`mr-3 ${isActive ? "text-indigo-400" : "text-slate-500"}`}
      >
        {icon}
      </span>
      {label}
  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-16 leading-relaxed">
        Experience a course that adapts to you. Generate curriculum instantly,
        take AI-proctored exams, and track your growth in 3D.
      </p>
      <SignInButton mode="modal">
        <Button
          size="lg"
          className="h-16 px-12 text-lg bg-white text-black hover:bg-indigo-50 hover:text-indigo-900 rounded-full shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] font-bold transition-all hover:scale-105 active:scale-95"
        >
          Get Started Now
        </Button>
      </SignInButton>
